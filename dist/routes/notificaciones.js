...
notificacionesRoutes.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var datos, mensaje, titulo, idSignal, datas, sendNotification, message;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, JSON.parse(req.query.datos)];
            case 1:
                datos = _a.sent();
                mensaje = datos.mensaje;
                titulo = datos.titulo;
                idSignal = datos.idSignal;
